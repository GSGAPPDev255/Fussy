...
export default function Browse() {
  ...
  const handleAction = (_action, _id) => {
    setIndex((i) => i + 1)
  }
  ...
  return (
    <div className="flex flex-col min-h-0 flex-1 px-4 pt-4 pb-4">
      ...
      {/* Less Fussy explanation banner */}
      {lessFussy && (
        <div className="mb-3 px-3 py-2 rounded-xl flex items-start gap-2 animate-fade-in"
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center px-6">
          ...
          <p className="text-sm leading-relaxed mb-6" style={{ color: 'rgba(255,255,255,0.3)' }}>
            {lessFussy
              ...
              : "Fussy's reciprocal filter means you only see people whose criteria you also meet. Try Less Fussy mode for more results."}
          </p>
        ...
        <div className="flex-1 flex flex-col justify-center">
          <div className="max-w-sm mx-auto w-full">
            ...
            {index === 0 && candidates.length > 0 && (
              <p className="text-center font-mono text-[10px] mt-4 animate-fade-in"
